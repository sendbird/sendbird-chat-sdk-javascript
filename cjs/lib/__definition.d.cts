...
export declare class GroupChannelModule extends Module {
  ...
  /**
   * @experimental This API is experimental and may be changed or removed at any time without notice.
   * @description Creates an InactiveChannelListQuery with the params.
   *  The query retrieves group channels that have been deactivated by channel rotation.
   *  Requires channel rotation to be enabled for the application.
   */
  createInactiveChannelListQuery(params?: InactiveChannelListQueryParams): InactiveChannelListQuery;
  /**
   * @param params
   * @returns
  ...
  /**
   * @experimental This API is experimental and may be changed or removed at any time without notice.
   * @description Builds InactiveChannelListQuery instance from serialized data generated by serialize.
   */
  buildInactiveChannelListQueryFromSerializedData(serialized: object): InactiveChannelListQuery;
  /**
   * @param serialized
   * @returns
...
/**
 * The inactive {@link GroupChannel} list order.
 * Ordered by the inactivation record id (when the channel was rotated out), not by any channel field.
 */
export declare enum InactiveChannelListOrder {
  /** Most recently deactivated membership first. (default) */
  LATEST = 'latest',
  /** Earliest deactivated membership first. */
  OLDEST = 'oldest',
}

/**
 * @description A class representing query to retrieve the list of GroupChannels that have been
 ...
 */
export declare class InactiveChannelListQuery extends BaseListQuery {
  /**
   * @description Result order of the inactive channels.
   */
  readonly order: InactiveChannelListOrder;
  /**
   * @description The custom type filter.
   *  It will return null if the custom type filter hasn't been set before.
   */
  readonly customType: string | null;
  /**
   * @returns
   * @description Serializes the InactiveChannelListQuery instance.
   *  This byte array can be stored in the database in your application. The instance can be restored by buildFromSerializedData.
   */
  serialize(): object;
  /**
   * @returns
   * @description Gets the list of inactive GroupChannels.
   *  If this method is repeatedly called after each next is finished,
...
export declare interface InactiveChannelListQueryParams extends BaseListQueryParams {
  /**
   * @description Result order of the inactive channels. (default: InactiveChannelListOrder.LATEST)
   */
  order?: InactiveChannelListOrder;
  /**
   * @description Restricts the results to inactive channels with the given custom type.
   */
  customType?: string;
}
